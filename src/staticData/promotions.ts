...
export const promotionArray: Array<PromotionModel> = [
  ...
  {
    id: ePromotion.PROMOTION_COUNTER_CITY_33,
    name: "攻城33",
    scene: eScene.SCENE_ATK,
    selfUnitType: [],
    selfTerrainType: eTerrainType.TERRAIN_ALL,
    ...
    targetModify: 0,
    barbarainOnly: false,
    description: "攻城战斗力+33%",
    uuid: [eUnit.UNIT_IRONCLAD],
    iconName: "PROMOTION_59.png",
  },
  {
  ...
  {
    id: ePromotion.PROMOTION_DESERT_WARRIOR,
    name: "沙漠战士",
    scene: eScene.SCENE_ALL,
    selfUnitType: [eUnitType.UNIT_TYPE_RIDING],
    selfTerrainType: eTerrainType.TERRAIN_ALL,
    ...
    targetModify: 0,
    barbarainOnly: false,
    description: "在沙漠地形战斗力+50%",
    uuid: [eUnit.UNIT_BERBER_CAVALRY],
    iconName: "PROMOTION_59.png",
  },
  {
    id: ePromotion.PROMOTION_HOME_DEFENSE,
    name: "保卫家园",
    scene: eScene.SCENE_ALL,
    selfUnitType: [eUnitType.UNIT_TYPE_RIDING],
    selfTerrainType: eTerrainType.TERRAIN_ALL,
