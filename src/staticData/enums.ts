...
export enum ePromotion {
  ...
  PROMOTION_HITCOAST_I,
  PROMOTION_HITCOAST_II,
  PROMOTION_HITCOAST_III,
  PROMOTION_VOLLEY,
  PROMOTION_STATUE_ZEUS,
  PROMOTION_STINGOUT,
  PROMOTION_COUTER_RIDING,
  PROMOTION_OUTSIDE_COUNTRY,
  PROMOTION_COUNTER_CITY_20,
  PROMOTION_COUNTER_CITY_33,
  ...
  PROMOTION_SWEDEN_GENENAL,
  PROMOTION_POLOA_PIONEER,
  PROMOTION_DESERT_WARRIOR,
  PROMOTION_HOME_DEFENSE,
  PROMOTION_RUSSIA_BLADE,
}
