...
export enum ePromotion {
  ...
  PROMOTION_EMBATTLE_I,
  PROMOTION_EMBATTLE_II,
  PROMOTION_STRIKE_I,
  PROMOTION_STRIKE_II,
  PROMOTION_STRIKE_III,
  PROMOTION_PRACTICE_I,
  PROMOTION_PRACTICE_II,
  PROMOTION_PRACTICE_III,
  PROMOTION_HIDE_I,
  PROMOTION_HIDE_II,
  PROMOTION_ACCURATE_I,
  PROMOTION_ACCURATE_II,
  PROMOTION_ACCURATE_III,
  PROMOTION_BARRAGE_I,
